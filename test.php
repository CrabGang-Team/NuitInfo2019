...
<body>
	...
	<div class="container-fluid main">
			      ...
			      <clr-input-container>
			        ...
			        <div class="clr-control-container">
			          <div class="clr-input-wrapper">
			            <input clrinput="" placeholder="Nom" class="clr-input ng-pristine ng-valid ng-touched" id="clr-form-control-191">
			          </div>
			        </div>
			      </clr-input-container>
			    </div>
		...
		<div class="image">
			...
			<span class="company">Ryerson.ca</span>
			<span class="center">Student Center.</span>
